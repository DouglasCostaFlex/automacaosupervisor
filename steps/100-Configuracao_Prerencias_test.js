Feature('Configuracao_Preferencias').tag('@ConfigPreferencias');
...
Scenario('01-Baixar Sincronização', () => {
    ...
    I.wait(1)
      //EU TIRO UMA FOTO
    I.saveScreenshot("100-01-Baixar Sincronizacao_Screenshot_Image.png");
    // EU COMPARO A FOTO COM A DA BASE.
    I.seeVisualDiff("100-01-Baixar Sincronizacao_Screenshot_Image.png", {tolerance: 2, prepareBaseImage: false});
    //eu aguardo
    I.wait(2)
...
Scenario('02-Inserir Config Manual', () => {
    ...
    I.wait(1)
      //EU TIRO UMA FOTO
    I.saveScreenshot("100-02-JSON-VAZIO_Screenshot_Image.png")
      //eu aguardo
    I.wait(1)
    //EU COMPARO A FOTO COM A DA BASE.
    I.seeVisualDiff("100-02-JSON-VAZIO_Screenshot_Image.png", {tolerance: 2, prepareBaseImage:false})
      //eu aguardo
    I.wait(1)
    //eu aperto no botao "OK"
